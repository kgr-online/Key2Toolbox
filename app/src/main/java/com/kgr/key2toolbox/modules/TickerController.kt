 ...
 * [com.kgr.key2toolbox.service.TickerOverlayController]), which only requires the app's
 * own accessibility service ([com.kgr.key2toolbox.service.Key2AccessibilityService]) to
 * be enabled.
 *
...
object TickerController {
    ...
    private const val SERVICE_COMPONENT =
        "com.kgr.key2toolbox/com.kgr.key2toolbox.service.TickerNotificationListenerService"
