...
fun K2PFScreen(onBack: () -> Unit) {
    ...
    ScreenScaffold(title = stringResource(Screen.K2PF.titleRes), onBack = onBack) {
        when (installed) {
                ...
                Card(modifier = Modifier.fillMaxWidth()) {
                    Column(
                        ...
                        if (k2tbOwnsSwappiness) {
                            ...
                            Text(
                                stringResource(R.string.k2pf_swappiness_current, swappiness?.toString() ?: stringResource(R.string.generic_not_set)),
                                style = MaterialTheme.typography.bodySmall,
                                color = MaterialTheme.colorScheme.onSurfaceVariant
                            )
